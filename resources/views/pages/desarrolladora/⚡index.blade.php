...
new class extends Component
{
    ...
    public ?Editora $editora = null;

    #[Validate('required|string|max:255')]
    public string $denominacion = '';

    #[Validate('required|exists:editoras,id')]
    public int $editora_id = 0;
    ...
    <div class="flex justify-center">
        ...
        <div class="w-full max-w-sm mx-auto" wire:show="modal">
            ...
            <form class="card bg-base-200 p-6 shadow" wire:submit.prevent="createUpdate">
                ...
                <label for="editoras" class="floating-label mt-4">
                    <span>editora:*</span>
                    <select name="editoras" id="editoras" wire:model="editora_id"class="select" >
